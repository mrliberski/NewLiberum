...
namespace ProFormaLibraries
{
    public class EadRequestTemplate
    {
        public string EadRequestFormModel(RequestModel request)
        {
            ...
            output += @"<tr><td align=""center"">&nbsp;<b>Request Type&nbsp;</td>";
            output += @$"<td align=""center"">&nbsp;{request.RequestType}</b>&nbsp;</td>";
            output += @"</tr>";
            ...
            output += @"<tr><td align=""center"">&nbsp;Customer Name&nbsp;</td>";
            output += @"<td align=""center"">&nbsp;Antolin Redditch&nbsp;</td>";
            output += @"</tr>";
            ...
            output += @"<tr><td align=""center"">&nbsp;Importer Name&nbsp;</td>";
            output += @$"<td align=""center"">&nbsp;{request.Customer}&nbsp;</td>";
            output += @"</tr>";
