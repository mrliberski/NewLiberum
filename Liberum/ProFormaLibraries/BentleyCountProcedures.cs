...
{
    public class BentleyCountProcedures
    {

            public static string BentleyCountEmailBody(List<BentleyCountModel> count)
            {
                string output = "";

                output += @"<html><head><style>body {color: #3d3d40;font-size:10pt;font-family:Calibri;}</style></head><body>";
                output += @"<h3>Bentley Components Daily Count&nbsp;</h3>";
                ...
                output += @"<tr><td align=""center"">&nbsp;<b>Component Name</b>&nbsp;</td>";
            ...
            output += @"</tr>";
                ...
                output += "</table>";
                output += "<br>Submitted on " + DateTime.Now.ToString("dd/MM/yyyy HH:mm");

                return output;
            }


            public static void SendBentleyCount(string email)
            {
                //Generate email
                DialogResult iExit;
                ...
                if (iExit == DialogResult.Yes)
                {
                    try
                    {
                        ...
                        string subject = "Bentley Components Daily Count > " + DateTime.Now.ToString();
